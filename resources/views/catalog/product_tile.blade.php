<div class="col-lg-4">
    <div class="product-tile">
        ...
        <div class="btn-round"><a href="#" onclick="$('#request-design-product').html('{{ $product->name }}'); $('#request-design-product').next().val('{{ $product->name }}'); return false;" data-toggle="modal" data-target="#requestDesignModal">Замерщик-дизайнер</a></div>
